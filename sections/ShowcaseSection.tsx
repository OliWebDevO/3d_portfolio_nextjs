...
const ShowcaseSection = () => {
  ...
  // Split projects for layout: first on left, others stacked right
    ...
    <section id="work" className="app-showcase" ref={showcaseRef}>
      <div className="w-full">
        <div className="showcaselayout xl:flex xl:gap-10 block">
          {/* LEFT : First project */}
          <div className="first-project-wrapper xl:w-[60%] w-full mb-10 xl:mb-0">
            <Link
            ...
            >
              <div
                ...
                style={{ background: firstProject.bg }}
              >
                <Image
                ...
                <div className="showcase-animated-bg flex items-center justify-center">
                  {firstProject.techLogos &&
                    firstProject.techLogos.map((logo, logoIdx) => (
                      <Image
                        key={logo}
                        src={logo}
              ...
              <div className="text-content flex flex-col justify-center mt-4">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold">{firstProject.title}</h2>
                <p className="text-white-50 md:text-xl mt-4">{firstProject.description}</p>
              </div>
            </Link>
          </div>
